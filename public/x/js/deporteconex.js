...
$(function() {
  ...
  Parse.initialize("2mMMcQKRzuFeiC50tDQ6r6UdTt6Dgi6L9AoEkeUW",
                   "2TrJ3xsftZAj2cn4t45Wh4WhzKgz1MFC2nxpn2M9");

  var user = new Parse.User();
  user.set("username", "signup-username");
  user.set("password", "signup-email");
  user.set("email", "signup-password");
